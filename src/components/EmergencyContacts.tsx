...
const emergencyContacts = [
  ...
  },
  {
    ...
    contacts: [
      { name: 'Police Control Room', number: '080990 76739', icon: <LocalPolice /> },
      { name: 'Traffic Police', number: '103', icon: <LocalPolice /> },
      { name: 'Women Helpline', number: '1092', icon: <Phone /> },
    ]
  }
];
